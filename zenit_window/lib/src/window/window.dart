...
class ZenitWindow extends StatefulWidget {
  ...
  /// WindowProperties to use for the application.
  ...
  @override
  State<ZenitWindow> createState() => _ZenitWindowState();
}

class _ZenitWindowState extends State<ZenitWindow> {
  @override
  void initState() {
    super.initState();
    initializeZenitWindow(widget.windowProperties ?? const WindowProperties());
  }
