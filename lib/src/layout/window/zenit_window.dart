...
class ZenitWindow {
  ...
  static Future<void> toggleMaximize() async =>
      await isMaximized() ? unmaximize() : maximize();
  ...
  static Future<void> alwaysOnTop(bool isAlwaysOnTop) async =>
  ...
  static Future<void> setBounds(Rect bounds) async =>
      windowManager.setBounds(bounds);

  /// Sets the window's minimum size.
  static Future<void> setMinSize(Size minimumSize) async =>
      windowManager.setMinimumSize(minimumSize);

  /// Sets whether the window is resizable.
  static Future<void> setResizable(bool isResizable) async =>
      windowManager.setResizable(isResizable);

  /// Sets whether the window is movable.
  static Future<void> setMovable(bool isMovable) async =>
      windowManager.setMovable(isMovable);
