...
export class Checkbox {
  ...
  render() {
    return <Host role="checkbox" aria-checked={this.ariaChecked} aria-disabled={this.disabled} tabindex={0}>
      <svg data-checked={this.value ?? 'off'} data-disabled={this.disabled} data-from-state={this.fromStateString()} width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
