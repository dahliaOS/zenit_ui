...
final examplePages = <ZenitLayoutItem>[
  ...
  ZenitLayoutItem(
    ...
    iconBuilder: (context, selected) => Icon(
        selected ? Icons.bubble_chart_rounded : Icons.bubble_chart_outlined),
  ),
  ZenitLayoutItem(
    titleBuilder: (context) => const Text("Tab View"),
    pageBuilder: (context) => const ZenitTabViewExample(),
    iconBuilder: (context, selected) =>
        Icon(selected ? Icons.tab_rounded : Icons.tab_unselected_rounded),
  ),
  ZenitLayoutItem(
  ...
  ZenitLayoutItem(
    ...
    iconBuilder: (context, selected) =>
        Icon(selected ? Icons.window_rounded : Icons.window_outlined),
  ),
];
